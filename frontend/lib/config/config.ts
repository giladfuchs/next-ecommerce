...
export const FOOTER_DATA =
  ...
  "ecommerce@gmail.com,Tel-Aviv,0521234567,ecommerce,ecommerce,https://github.com/giladfuchs/next-ecommerce";
export const WHATSAPP_MESSAGE = process.env.NEXT_PUBLIC_WHATSAPP_MESSAGE;

export const ICON_IMAGE_URL =
  process.env.NEXT_PUBLIC_ICON_IMAGE_URL ?? "/logo.png";

// Max upload size: 5 MB (easy to tweak to 2 or 1.5)
export const MAX_FILE_SIZE_MB = 5 * 1024 * 1024;
