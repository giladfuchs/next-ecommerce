...
import type { PropsProductButtons } from "@/components/products/single/product-buttons";
import type { PropsProductGallery } from "@/components/products/single/product-gallery";
